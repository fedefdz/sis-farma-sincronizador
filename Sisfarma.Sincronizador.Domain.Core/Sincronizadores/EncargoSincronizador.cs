...
namespace Sisfarma.Sincronizador.Domain.Core.Sincronizadores
{
    ...
    {        
        ...
        public EncargoSincronizador(FarmaciaService farmatic, FisiotesService fisiotes, ConsejoService consejo) 
        ...
        private Fisiotes.Models.Encargo GenerarEncargo(FarmaciaService farmatic, Farmatic.Models.Encargo encargo, ConsejoService consejo)
        {            
        ...
        string GetNombreLaboratorioFromLocalOrDefault(FarmaciaService farmaticService, ConsejoService consejoService, string codigo, string byDefault = "")
        {
