...
namespace Sisfarma.Sincronizador.Domain.Core.Sincronizadores
{
    public class ListaSincronizador : TaskSincronizador
    {
        ...
        public ListaSincronizador(FarmaciaService farmatic, FisiotesService fisiotes) 
        ...
        private void ProcessListas(FarmaciaService farmatic, FisiotesService fisiotes)
        {
