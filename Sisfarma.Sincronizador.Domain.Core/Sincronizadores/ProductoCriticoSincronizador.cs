...
namespace Sisfarma.Sincronizador.Domain.Core.Sincronizadores
{
    public class ProductoCriticoSincronizador : TaskSincronizador
    {
        ...
        public ProductoCriticoSincronizador(FarmaciaService farmatic, FisiotesService fisiotes, ConsejoService consejo) 
        ...
        private Fisiotes.Models.Falta GenerarFaltante(FarmaciaService farmatic, Pedido pedido, LineaPedido linea, Articulo articulo, ConsejoService consejo)
        {
