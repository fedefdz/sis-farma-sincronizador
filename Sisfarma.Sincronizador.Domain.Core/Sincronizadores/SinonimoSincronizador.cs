...
namespace Sisfarma.Sincronizador.Domain.Core.Sincronizadores
{
    public class SinonimoSincronizador : TaskSincronizador
    {
        ...
        public SinonimoSincronizador(FarmaciaService farmatic, FisiotesService fisiotes)
        ...
        public void ProcessSinonimos(FarmaciaService farmaticService, FisiotesService fisiotesService)
        {
