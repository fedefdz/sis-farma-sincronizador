...
namespace Sisfarma.Sincronizador.Domain.Core.Sincronizadores
{
    ...
    {
        public PuntoPendienteActualizacionSincronizador(FarmaciaService farmatic, FisiotesService fisiotes) 
        ...
        private void ProcessUpdatePuntosPendientes(FarmaciaService farmatic, FisiotesService fisiotes)
        {
