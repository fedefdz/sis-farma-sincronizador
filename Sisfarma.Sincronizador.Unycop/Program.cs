...
namespace Sisfarma.Sincronizador.Unycop
{
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            Task.Factory.StartNew(() => new Domain.Core.Sincronizadores.ListaSincronizador(FarmaciaFactory.Create(), SisfarmaFactory.Create()).SincronizarAsync(Updater.GetCancellationToken(), delayLoop: 1));
